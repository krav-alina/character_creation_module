...
def attack(char_name: str, char_class: str) -> str:
    """Return attack performance of the chosen character."""
...
def defence(char_name: str, char_class: str) -> str:
    """Return defence performance of the chosen character."""
    if char_class == 'warrior':
...
def special(char_name: str, char_class: str) -> str:
    """Return special skill usage of the chosen character."""
    if char_class == 'warrior':
...
def start_training(char_name: str, char_class: str) -> str:
    """Return general characteristics of the chosen personage."""
    if char_class == 'warrior':
...
def choice_char_class() -> str:
    """Suggest to choose your character and return it."""
    approve_choice: str = ''
    char_class: str = ''
